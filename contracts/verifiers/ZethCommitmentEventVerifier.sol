...
contract ZethCommitmentEventVerifier is EventVerifier {
    ...
    function verify(bytes20 _contractEmittedAddress, bytes memory _rlpReceipt, uint256 _expectedAddress, bytes32 _expectedCommitment) public view returns (bool) {
